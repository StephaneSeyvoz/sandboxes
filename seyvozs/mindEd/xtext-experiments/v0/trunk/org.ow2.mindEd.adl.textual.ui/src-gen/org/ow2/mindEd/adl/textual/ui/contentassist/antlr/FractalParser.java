		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPrimitiveDefinitionAccess().getGroup_5_2(), "rule__PrimitiveDefinition__Group_5_2__0");
					...
					put(grammarAccess.getTypeDefinitionAccess().getGroup_3_2(), "rule__TypeDefinition__Group_3_2__0");
					...
					put(grammarAccess.getPrimitiveDefinitionAccess().getSuperTypesAssignment_5_1(), "rule__PrimitiveDefinition__SuperTypesAssignment_5_1");
					put(grammarAccess.getPrimitiveDefinitionAccess().getSuperTypesAssignment_5_2_1(), "rule__PrimitiveDefinition__SuperTypesAssignment_5_2_1");
					...
					put(grammarAccess.getTypeDefinitionAccess().getSuperTypesAssignment_3_1(), "rule__TypeDefinition__SuperTypesAssignment_3_1");
					put(grammarAccess.getTypeDefinitionAccess().getSuperTypesAssignment_3_2_1(), "rule__TypeDefinition__SuperTypesAssignment_3_2_1");
