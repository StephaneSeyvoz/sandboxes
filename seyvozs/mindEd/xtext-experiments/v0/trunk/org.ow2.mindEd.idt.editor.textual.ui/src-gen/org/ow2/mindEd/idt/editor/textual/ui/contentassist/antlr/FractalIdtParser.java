		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStructOrUnionDefinitionAccess().getNameAssignment_1(), "rule__StructOrUnionDefinition__NameAssignment_1");
					...
					put(grammarAccess.getStructorUnionReferenceAccess().getNameAssignment_1(), "rule__StructorUnionReference__NameAssignment_1");
